...
async function signup(req, res, next) {
  ...
  if (
    ...
    sessionFlash.flashDataToSession(
      ...
      {
        errorMessage:
          "Please check your input. Password must be at least 6 character long, postal code must be 5 characters long. ",
        // the enteredData object bellow will be spread into this object here by spread operator
        ...enteredData,
      },
      function () {
        res.redirect("/signup");
